...
stop_button = tk.Button(text = "Die", command = Stop, width = 10)
stop_button.place(x = 40, y = 100)

test = tk.Button(text = "test", command = test, width = 10)
test.place(x = 40, y = 150)
